...
export type BranchCreateInput = {
  name: string
  assets?: Prisma.AssetCreateNestedManyWithoutBranchRefInput
}

export type BranchUncheckedCreateInput = {
  name: string
  assets?: Prisma.AssetUncheckedCreateNestedManyWithoutBranchRefInput
}

export type BranchUpdateInput = {
  name?: Prisma.StringFieldUpdateOperationsInput | string
  assets?: Prisma.AssetUpdateManyWithoutBranchRefNestedInput
}

export type BranchUncheckedUpdateInput = {
  name?: Prisma.StringFieldUpdateOperationsInput | string
  assets?: Prisma.AssetUncheckedUpdateManyWithoutBranchRefNestedInput
}
...
export type BranchOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name", ExtArgs["result"]["branch"]>
...
export interface BranchDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Branches and only return the `name`
   * const branchWithNameOnly = await prisma.branch.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Branches and only return the `name`
   * const branchWithNameOnly = await prisma.branch.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
