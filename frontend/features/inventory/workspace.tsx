'use client';
import {useState,useEffect,useCallback} from 'react';import {Package,LayoutDashboard,Upload,ArrowLeftRight,QrCode,BarChart3,Users,History,Plus,Search,Download,ChevronRight,ArrowUpDown,FileSpreadsheet,ShieldCheck,Coins,TriangleAlert,FileCheck2,ArrowRight,LogOut,RefreshCw} from 'lucide-react';
...
import {Asset,Role,roles,conditions,headers11,money} from '@/shared/domain';import {exportWorkbook} from '@/frontend/services/excel-export';import {Any,api,Badge,Pick,Empty,Metric,Pager,Activity} from '@/frontend/components/common';import {useAssetTools} from '@/frontend/hooks/use-asset-tools';import Editor from './editor';import ImportView from '@/frontend/features/imports/import-view';import Operations from '@/frontend/features/operations/operations';
